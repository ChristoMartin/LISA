...
cd $PBS_O_WORKDIR
SAVEDIR=.model/lisa/discounting/glove/conll05-lisa-decedent-parent
CONF=config/lisa/discounting/glove/conll05-lisa-decedent-parent.conf
