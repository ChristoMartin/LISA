...
cd $PBS_O_WORKDIR
SAVEDIR=.model/lisa/discounting/elmo/conll05-lisa-decedent-parent-with-score
CONF=config/lisa/discounting/elmo/conll05-lisa-decedent-parent-with-score.conf
