...
#PBS -N MLP-LA-HI-CWR-DROPOUT-BN
#PBS -j oe
...
cd $PBS_O_WORKDIR
SAVEDIR=.model/mlp-la/injection/glove-dep/conll05-cwr-dropout-bn
CONF=config/mlp-la/injection/glove-dep/conll05-cwr.conf
SINGULARITY_IMG=/lustre/gk77/k77015/.Singularity/imgs/LISA.simg
ADDITIONAL_PARAMETERS=" --parser_dropout --aggregator_mlp_bn "
