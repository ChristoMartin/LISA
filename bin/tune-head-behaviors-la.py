...
out_dir = os.path.join(args.output_dir, "tune-head-behavior-linear-" + datetime_str)
...
params = {
  ...
  'parse_dep_injection': ['injection', 'discounting'],
  'special_attention_mode': ['discounting', 'okazaki_discounting'],
