...
def token_based_batching(dataset,
             batch_size_means_tokens,
  ...
  def gpu_valid_size(example):
    drop_long_sequences = drop_long_sequence
    max_validate_length = max_length if drop_long_sequences else 10**9
    return example_valid_size(example, min_length, max_validate_length)
  ...
  if not batch_size_means_tokens:
    ...
    batch_size = batchsize * num_shards
    ...
    cur_batching_scheme = _batching_scheme(
      batch_size=batchsize,
      min_length=min_length,
